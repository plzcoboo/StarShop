...
margin-bottom:30px; position:relative;
 form {
    ...
    p {        
        input[type=text] { width:350px; box-sizing:border-box; height:45px; padding:10px; margin-right:10px; background:#E3F2FD; border:none; color: #fff; border-radius:10px;}
